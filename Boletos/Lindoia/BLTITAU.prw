...
±±∫Programa  ≥ BLTITAU  ∫Autor  ≥Microsiga           ∫ Data ≥  12/11/15   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Descricao ≥ Impressao de boleto Itau                                   ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ AP                                                         ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕ'ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±*/
...
DEFINE MsDialog oDlg1 From 0,0 To 350,300 Title "EMISS√O DE BOLETOS" Pixel Style DS_MODALFRAME // Cria Dialog sem o bot„o de Fechar.
//oDlg1:lTEscClose := .F.
                      
oSay1      := TSay():New( 05,25,{||"EMISS√O DE BOLETOS"},oDlg1,,oFont1,.F.,.F.,.F.,.T.,CLR_BLUE,CLR_WHITE,160,012)
...
PutSx1(cPerg,"05","De Parcela"	 ,"","","mv_ch5","C", 3,0,0,"G","",""   ,"","","mv_par05","","","","","","","","","","","","","","","","",{},{},{})
PutSx1(cPerg,"06","Ate Parcela"	 ,"","","mv_ch6","C", 3,0,0,"G","",""   ,"","","mv_par06","","","","","","","","","","","","","","","","",{},{},{})
...
If Empty(__cNumNot)
	...
	__cFilter += "E1_PREFIXO >= '" + m¡v_par01 + "' .and. E1_PREFIXO<='" + mv_par02 + "' .and. "
...
// original 	__cIdxKey := "¡E1_PORTADO+E1_CLIENTE+E1_PREFIXO+E1_NUM+E1_PARCELA+E1_TIPO+DtoS(E1_EMISSAO)"
...
/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ MONTAREL ∫Autor  ≥Microsiga           ∫ Data ≥  12/11/15   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥                                                            ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
...
Local __aDadBco := {}
Local __aDadSac := {}
Local __aBolTxt := {"APOS O VENCIMENTO COBRAR MORA DE R$....... ","PROTESTAR NO DIA ","AO DIA","ATENCAO-->> SR. CAIXA N√O RECEBER APOS O VENCIMENTO"}
Local __cMntBar := {}
Local __nVlrAbt := 0
Local __cNosNum := ""
Local __cDigNum := ""
...
__oPrnBol:Setup()   // Inicia uma nova p·gina
...
While !EOF()
	...
	If Marked("E1_OK")
		...
		aAdd(__aDadBco, Left(Alltrim(SA6->A6_AGENCIA),4)) 	// [3]AgÍncia
		aAdd(__aDadBco, Alltrim(SA6->A6_NUMCON))   			// [4]Conta Corrente
		aAdd(__aDadBco, Alltrim(SA6->A6_DVCTA))  				// [5]DÌgito da conta corrente
		aAdd(__aDadBco, Alltrim(__cCartei))     				// [6]Codigo da Carteira
		
		If Empty(SA1->A1_ENDCOB)
			__aDadSac := {	AllTrim(SA1->A1_NOME)           						 	,;      	// [1]Raz„o Social
		...
		__aDadTit := {	AllTrim(E1_NUM)+AllTrim(E1_PARCELA)	,; // [1] N˙mero do tÌtulo
							E1_EMISSAO                          ,;	// [2] Data da emiss„o do tÌtulo
							dDataBase                    			,;	// [3] Data da emiss„o do boleto
							E1_VENCTO                           ,;	// [4] Data do vencimento
							(E1_VALOR - __nVlrAbt)              ,;	// [5] Valor do tÌtulo
							__cMntBar[3]                        ,;	// [6] Nosso n˙mero (Ver fÛrmula para calculo)
...
__oPrnBol:EndPage() // Finaliza a p·gina
...
/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ IMPRESS  ∫Autor  ≥Microsiga           ∫ Data ≥  12/11/15   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
...
__oPrnBol:StartPage()   // Inicia uma nova p·gina
// PRIMEIRA PARTE 
__nNumLin := 0
...
__oPrnBol:Say(__nNumLin+0150,1060,"AgÍncia/CÛdigo do Benefici·rio",oFont8)
...
__oPrnBol:Say(__nNumLin+0400,0100,"Recebi(emos) o bloqueto/tÌtulo com as caracteristicas acima.",oFont8)
...
__oPrnBol:Say(__nNumLin+0245,1910,"(  )N„o existe n∫ indicado"  ,oFont8)
__oPrnBol:Say(__nNumLin+0285,1910,"(  )Recusado"                ,oFont8)
__oPrnBol:Say(__nNumLin+0325,1910,"(  )N„o procurado"           ,oFont8)
__oPrnBol:Say(__nNumLin+0365,1910,"(  )EndereÁo insuficiente"   ,oFont8)
...
__oPrnBol:Say(__nNumLin+0810,1810,"AgÍncia/CÛdigo do Benefici·rio",oFont8)
...
__oPrnBol:Say(__nNumLin+0910,1005,"EspÈcie Doc.",oFont8)
...
__oPrnBol:Say(__nNumLin+0910,1810,"Nosso N˙mero",oFont8)
...
__oPrnBol:Say(__nNumLin+0980,755 ,"EspÈcie",oFont8)
...
__oPrnBol:Say(__nNumLin+1050,100 ,"InstruÁıes de responsabilidade do benefici·rio. Qualquer d˙vida sobre este boleto, contate o benefici·rio.",oFont8)
...
__oPrnBol:Say(__nNumLin+1350,100 ,"ATENCAO : SR. CAIXA N√O RECEBER APOS "+StrZero(Day(__aDadTit[4]+4),2) +"/"+ StrZero(Month(__aDadTit[4]+4),2) +"/"+ Right(Str(Year(__aDadTit[4]+4)),4) ,oFont14)        
...
__oPrnBol:Say(__nNumLin+1120,1810,"(-)Outras DeduÁıes",oFont8)
__oPrnBol:Say(__nNumLin+1190,1810,"(+)Mora/Multa",oFont8)
__oPrnBol:Say(__nNumLin+1260,1810,"(+)Outros AcrÈscimos",oFont8)
...
__oPrnBol:Say(__nNumLin+1645,1500,"AutenticaÁ„o Mec‚nica",oFont8)
...
__oPrnBol:Say(__nNumLin+2100,1810,"AgÍncia/CÛdigo do Benefici·rio",oFont8)
__cString := Alltrim(__aDadBco[3]+"/"+__aDadBco[4]+"-"+__aDadBco[5])
__nColuna := 1810+(374-(len(__cString)*22))
...
__oPrnBol:Say(__nNumLin+2200,1005,"EspÈcie Doc.",oFont8)
...
__oPrnBol:Say(__nNumLin+2200,1810,"Nosso N˙mero",oFont8)
__cString := Alltrim(SubStr(__aDadTit[6],1,3)+"/"+AllTrim(SE1->E1_NUMBCO))
...
__oPrnBol:Say(__nNumLin+2270,755 ,"EspÈcie",oFont8)
...
__oPrnBol:Say(__nNumLin+2340,100 ,"InstruÁıes de responsabilidade do benefici·rio. Qualquer d˙vida sobre este boleto, contate o benefici·rio.",oFont8)
...
__oPrnBol:Say(__nNumLin+2630,100 ,"ATENCAO : SR. CAIXA N√O RECEBER APOS "+StrZero(Day(__aDadTit[4]+4),2) +"/"+ StrZero(Month(__aDadTit[4]+4),2) +"/"+ Right(Str(Year(__aDadTit[4]+4)),4) ,oFont14)        
...
__oPrnBol:Say(__nNumLin+2410,1810,"(-)Outras DeduÁıes",oFont8)
__oPrnBol:Say(__nNumLin+2480,1810,"(+)Mora/Multa",oFont8)
__oPrnBol:Say(__nNumLin+2550,1810,"(+)Outros AcrÈscimos",oFont8)
...
__oPrnBol:Say(__nNumLin+2855,1500,"AutenticaÁ„o Mec‚nica - Ficha de CompensaÁ„o",oFont8)
...
/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥FLINHADIG ∫Autor  ≥Microsiga           ∫ Data ≥  12/11/15   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ ObtenÁ„o da linha digitavel/codigo de barras               ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ AP                                                        ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
...
Static Function fLinhaDig (__cCodBco ,; // Codigo do Banco (341)
									...
									__cDigCta ,; // Digito verificador¡ da Conta
...
//CAMPO 2:
//DDDDDD= Restante do Nosso N˙mero
//E = DAC do campo [AgÍncia/Conta/Carteira/ Nosso N˙mero]
//FFF = TrÍs primeiros n˙meros que identificam a AgÍncia
...
//CAMPO 3:
//F = Restante do n˙mero que identifica a agÍncia
//GGGGGG = N˙mero da conta corrente + DAC
...
/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ MODULO10 ∫Autor  ≥Microsiga           ∫ Data ≥  12/11/15   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ C·lculo do Modulo 10 para obtenÁ„o do DV dos campos do CB  ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Uso       ≥ AP                                                         ∫±±
±±»ÕÕÕÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕº±±
...
/*±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±…ÕÕÕÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÀÕÕÕÕÕÕ—ÕÕÕÕÕÕÕÕÕÕÕÕÕª±±
±±∫Programa  ≥ MODULO11 ∫Autor  ≥Microsiga           ∫ Data ≥  12/11/15   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ C·lculo do Modulo 10 para obtenÁ„o do DV dos campos do CB  ∫±±
±±∫          ≥                                                            ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
