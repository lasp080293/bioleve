...
cQuery+= " A1_CGC, A1_END,A1_CEP,A1_BAIRRO,A1_MUN,A1_EST,A1_NOME,A1_END, A1_MUN, A1_BAIRRO,A1_EST,A1_CEP,"
...
oPrn:Say( nRow1+1205, 0200, ALLTRIM(TbBol->A1_END), oFont12,100)
...
oPrn:Say( nRow1+3065, 0200, ALLTRIM(TbBol->A1_END), oFont12,100)
