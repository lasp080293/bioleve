...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �BOLSANT   �Autor  �Microsiga           � Data �  12/20/11   ���
�������������������������������������������������������������������������͹��
���Desc.     � Impressao do boleto grafico santander.                     ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � AP                                                         ���
�������������������������������������������������������������������������ͼ��
...
If Pergunte (cPerg,.T.)
	...
	// Seleciona os registros para marca��o
	MsgRun( "T�tulos a Receber", "Selecionando registros para processamento", { || CallRegs(@aTitulos)} )
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �CallRegs  �Autor  �Microsiga           � Data �  12/20/11   ���
�������������������������������������������������������������������������͹��
���Desc.     � Carrega os titulos conforme os parametros informados pelo  ���
���          � usuario                                                    ���
�������������������������������������������������������������������������͹��
���Uso       � AP                                                         ���
�������������������������������������������������������������������������ͼ��
...
While !Eof()
	...
	FINR01A->E1_EMISSAO,;		// 10=Data de Emiss�o do T�tulo
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �CallTela  �Autor  �Caio Costa          � Data �  12/20/11   ���
�������������������������������������������������������������������������͹��
���Desc.     � Carrega os titulo no objeto para o usuario selecionar os   ���
���          � que ser�o impressos                                        ���
�������������������������������������������������������������������������͹��
���Uso       � AP                                                         ���
�������������������������������������������������������������������������ͼ��
...
Local aLabel	:= {" ","Prefixo","N�mero","Parcela","Tipo","Natureza","Cliente","Loja","Nome Cliente","Emiss�o","Vencimento","Venc.Real","Valor","Hist�rico","Nosso N�mero"}
Local aBotao    := {}
Local lRetorno	:= .T.
Local lMark		:= .F.
Local cList1
...
AADD(aBotao, {"S4WB011N" 	, { || U__RFINR01C("SE1",SE1->(aTitulos[oList1:nAt,15]),2)}, "[F12] - Visualiza T�tulo", "T�tulo" })
SetKey(VK_F10,	{|| U__RFINR01C("SE1",SE1->(aTitulos[oLis1:nAt,15]),2)})


Aviso(	"Numera��o Banc�ria",;
			"N�o esquecer de verificar o n�mero banc�rio antes de gerar os boletos.",;
			{"&Ok"},,;
			"A T E N � � O" )
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �RFINR01A  �Autor  �Microsiga           � Data �  12/20/11   ���
�������������������������������������������������������������������������͹��
���Desc.     � Caso n�o seja selecionado nenhum titulo finaliza o objeto  ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � AP                                                         ���
�������������������������������������������������������������������������ͼ��
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �RFINR01B  �Autor  �Microsiga           � Data �  12/20/11   ���
�������������������������������������������������������������������������͹��
���Desc.     � Verifica a quantidades de boletos que ser�o impressos      ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
���Uso       � AP                                                         ���
�������������������������������������������������������������������������ͼ��
...
�����������������������������������������������������������������������������
�������������������������������������������������������������������������ͻ��
���Programa  �BOLITAU   �Autor  �Microsiga           � Data �  12/20/11   ���
�������������������������������������������������������������������������͹��
���Desc.     �                                                            ���
���          �                                                            ���
�������������������������������������������������������������������������͹��
...
LOCAL aBolText     := { "Valor da Mora por Dia de Atraso de R$ "	,;   		//[1]Mora Diaria
								"Protestar ap�s 5 dias do vencimento.."}   	    //[2]Sujeito a Protesto
...
For nI:=1 To Len(aTitulos)
	...
	If Empty(SA1->A1_ENDCOB)
		aDatSacado   := { AllTrim(SA1->A1_NOME)          						 							  ,;     	// [1]Razao Social
								...
								AllTrim(SA1->A1_END )+"-"+Alltrim(SA1->A1_COMPLEM)+"-"+AllTrim(SA1->A1_BAIRRO),;    	// [3]Endere�o
	...
	aDadosTit := { AllTrim(SE1->E1_NUM)+AllTrim(SE1->E1_PARCELA)   				,;  // [1] N�mero do t�tulo e parcela
						...
						SE1->E1_NUMBCO							 				,;  // [6] Nosso n�mero (Ver f�rmula para calculo)
...
oPrint:Say(nRow2+0150,1060,"Ag�ncia/C�digo do Cedente",oFont8)
...
oPrint:Say(nRow2+0400,0100,"Recebi(emos)o boleto/t�tulo com as caracteristicas acima.",oFont8)
...
oPrint:Say(nRow2+0245,1910,"(  )N�o existe n� indicado"  ,oFont8)
oPrint:Say(nRow2+0285,1910,"(  )Recusado"                ,oFont8)
oPrint:Say(nRow2+0325,1910,"(  )N�o procurado"           ,oFont8)
oPrint:Say(nRow2+0365,1910,"(  )Endere�o insuficiente"   ,oFont8)
...
oPrint:Say  (nRow2+0310,100 ,"Benefic�rio"                                        ,oFont8)
oPrint:Say  (nRow2+0350,100 ,aDadosEmp[1]+"       - "+aDadosEmp[6]	,oFont10) //Nome + CNPJ

oPrint:Say  (nRow2+0310,1810,"Ag�ncia/C�digo Cedente",oFont8)
...
oPrint:Say  (nRow2+0410,1005,"Esp�cie Documento"                                   ,oFont8)
...
oPrint:Say  (nRow2+0480,755 ,"Esp�cie"                                        ,oFont8)
...
oPrint:Say  (nRow2+0550,100 ,"Instru��es (Termo de responsabilidade do cedente)",oFont8)
...
oPrint:Say  (nRow2+0760,1810,"(+)Outros Acr�scimos"                        ,oFont8)
...
oPrint:Say  (nRow2+0970,400 ,aDatSacado[3]                                 				,oFont10)    		  // Endere�o
...
oPrint:Say  (nRow2+1145,1500,"Autentica��o Mec�nica",oFont8)
...
oPrint:Say  (nRow3+2200,1005,"Esp�cie Documento"                                   									,oFont8)
...
oPrint:Say  (nRow3+2340,100 ,"Instru��es (Termo de responsabilidade do cedente)"									,oFont8)
...
Else
	oPrint:Say  (nRo�w3+2850,400,"CNPJ: "+TRANSFORM(aDatSacado[7],"@R 99.999.999/9999-99")			,oFont10) // CGC
EndIf
oPrint:Say  (nRow3+2910,100 ,"Sacador/Avalista"                              		    	        ,oFont8)
oPrint:Say  (nRow3+2910,1500,"Autentica��o Mec�nica - Ficha de Compensa��o"                         ,oFont8)
